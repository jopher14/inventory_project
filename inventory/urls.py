...
urlpatterns = [
    ...
    path('asset/<int:pk>/accountability/pdf/', views.generate_accountability_pdf, name='generate_accountability_pdf'),
    path('asset/<int:pk>/accountability/upload/', views.upload_accountability_scan, name='upload_accountability_scan'),
]
