...
from .models import Asset, LaptopSpec, MonitorSpec, CellphoneSpec, OtherSpec
...
class AssetForm(forms.ModelForm):
    class Meta:
        model = Asset
        fields = ['unit_name', 'company_tag', 'serial_number', 'asset_type', 'assigned_to', 'status', 'date_purchased']
        widgets = {
